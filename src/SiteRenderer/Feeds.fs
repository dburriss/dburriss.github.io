...
module Feeds =
    ...
    let private xmlEscape (value: string) =
        ...
        else WebUtility.HtmlEncode(value)
        ...
        let entries =
            ...
            |> List.map (fun post ->
                ...
                let summary =
                    ...
                    |> Option.defaultValue ""
                XElement(xns atomNs "entry",
                    XElement(xns atomNs "id", postUrl),
                    XElement(xns atomNs "link",
                    ...
                    XElement(xns atomNs "author",
                        XElement(xns atomNs "name", author),
                        XElement(xns atomNs "uri", postUrl)),
                    XElement(xns atomNs "summary",
                        XAttribute(xn "type", "html"),
                        summary)))

        let feed =
            XElement(xns atomNs "feed",
