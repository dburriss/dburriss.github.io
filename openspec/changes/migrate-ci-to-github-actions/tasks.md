...
- [x] 1.1 Create `publish.ps1` (PowerShell) script to push `_site` to master branch
- [x] 1.2 Create `publish.sh` (Bash) script to push `_site` to master branch
- [x] 1.3 Scripts should handle git configuration, commit, and force-push to master
