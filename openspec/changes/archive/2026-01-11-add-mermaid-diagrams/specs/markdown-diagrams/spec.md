# Capability: Markdown Diagrams

## Purpose
Enable authors to include visual diagrams in markdown content using text-based Mermaid syntax, with automatic rendering to SVG graphics that integrate with the site's theme system.
