...
## Purpose
Define a stable topic taxonomy and attach topics to posts/drafts without changing rendering. This change introduces topic configuration, a topic assignment artifact, and reproducible scripts to apply `topics`/`keywords` front matter across existing Markdown content.
